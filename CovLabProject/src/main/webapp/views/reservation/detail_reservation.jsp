							...
							<div class="card_header">
								...
								<div class="card-body">
									...
									<form action ="/semi/insertres" method="post">
										...
										<div class="form-group">
											<label for="hp_phone">전화번호 : </label><input type="text" name="hp_phone" value="<%=hp.getHp_phone() %>" readonly id="inputBox">
										</div>
										<div class="form-group">
											<label for="">백신 : </label> <input type="text" name="serial_num" value="PF0003" readonly id="inputBox">
										</div>
										<div class="form-group">
											<label for="">예약일시 : </label> 
											<input type="text" name="rev_date" value="2021-06-29 09:30:00" readonly id="inputBox">
											<br>
											<a href = "javascript:void(0)" target = "_blank" onclick="reservationDatePopup()">날짜 선택</a>
										</div>
										<input type="hidden" name="reg_bus_no" value=<%= hp.getReg_bus_no() %> id="inputBox">
									<div class="form-row  text-center">
									
									
										<a href="javascript:void(0)" target = "_blank" onclick= "termsPopup()" class="btn">예약</a>
