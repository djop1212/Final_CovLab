...
<script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDOlKn_MoHoMoN2w_vlAxgK_eC3kbWcPN0&callback=initMap"></script>
...
<script>
	...
	function showMarker() {
		...
		var marker2 = new google.maps.Marker({
			...
			icon : img,
			map : map
		//이렇게 마커를 만들면서 map객체에 추가시킬 수 있음. setMap()
		});
		...
		var pharmacys = [ [ '희망약국', 37.562516, 127.035679 ],
