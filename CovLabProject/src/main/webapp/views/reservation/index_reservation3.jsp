...
<script
   src="http://maps.google.com/maps/api/js&key=AIzaSyCZ8XJruaL1nd6GJOryueJE_Av5O6mU5H0"
...
//지도 만듷고 중앙을 현재 위치로 설ㅇ
    var map = new google.maps.Map(
          document.getElementById('map'), {
        zoom: 11.5,
        center: latlng//new google.maps.LatLng(37.559085, 126.998501),
